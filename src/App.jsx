...
//   // Check if the color has already been used
//   const colorAlreadyThere = results.some(
//     (obj) => obj.color.toLowerCase() === langColor.toLowerCase()
//   );
...
//         setResults((prevResults) => [
//           ...prevResults,
//           { attempt: prevResults.length + 1, color: langColor, result: 'win' },
//         ]);
...
//         setResults((prevResults) => [
//           ...prevResults,
//           { attempt: prevResults.length + 1, color: langColor, result: 'lose' },
//         ]);
...
//       <h1>Welcome To Our Programming Language Game</h1>
//       <p style={{ fontSize: '20px', color: 'blue' }}>Match a language with its color and gain a point!</p>
